<template>
  <div id="traffic-entropy-chart">
    ...
    <div class="dv-charts-container" id="lineChart" style="width: 100%; height: 100%;" ></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    drawLineChart() {
        ...
        this.lineChart = echarts.init(document.getElementById('lineChart'),'dark');
      ...
      this.option  = {
            ...
            series: [
              ...
              },
              {
                ...
                data: [300, 28, 20, 260, 20, 300, 550, 500, 40, 390, 380, 30, 40, 500, 600, 750, 800, 700, 600, 400],
              }
