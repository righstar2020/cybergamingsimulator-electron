<template>
  <div class="LineChartComponent">
      <div id="PortScanLineChart" style="width: 600px; height: 400px;" >
      </div>
  </div>
</template>
...
export default {
  ...
  methods:{
    ...
    proccessTaskData(envStatusResult){
        console.log("envStatusResult:",envStatusResult)
        ...
        console.log("seriesDataMap",seriesDataMap)
